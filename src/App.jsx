...
function App() {
  ...
  const handleInputChange=(e)=>{
    const {value,name}=e.target;//e.target.value & e.target.name 解構賦值
    //更新account狀態
    setAccount({
      ...account,
      [name]:value
  ...
  return (
    <>
      ...
      (<div className="container py-5">
        <div className="row">
          <div className="col-6">
            <button type="button" className="btn btn-primary mb-5 px-3 py-3"
              onClick={checkUserLogin}>檢查用戶是否已登入</button>
            <h2>產品列表</h2>
      ...
      (<div className="d-flex flex-column justify-content-center align-items-center vh-100">
        ...
        <form onSubmit={handleLoginChange} className="d-flex flex-column gap-3">
